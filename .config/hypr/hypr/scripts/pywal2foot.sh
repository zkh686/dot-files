#!/bin/sh
# pywal2foot - get colors from Pywal and apply to foot config
# v0.2.0
# github.com/egeesin
#
# Deps: grep, sed
...
DEFAULT_MACOS_CONFIG="$HOME"/.config/foot/foot.ini
...
if [ -n "$1" ]; then
  ...
  [ -e "$DEFAULT_MACOS_CONFIG" ] || die "foot config not found, exiting script."
